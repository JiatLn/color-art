...
mod tests {
    ...
    #[test]
    fn test_rgb2ycbcr() {
        assert_eq!(rgb2ycbcr(&[255.0, 255.0, 0.0]), vec![225.93, 0.5754800000000131, 148.72691]);
        assert_eq!(
    ...
    #[test]
    fn test_ycbcr2rgb() {
        assert_eq!(ycbcr2rgb(&[225.93, 0.5754800000000131, 148.72691]), vec![255.0, 255.0, 0.0]);
        assert_eq!(
